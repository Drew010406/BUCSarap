...
from backend.src.routers import owner, products, stalls, history, orders, owner_stall, queue
...
app.include_router(orders.orders_route, prefix="/orders", tags=["Orders"])
app.include_router(owner_stall.route, prefix="/owner_stall", tags=["Owner functionalities"])
app.include_router(queue.queue_route, prefix="/queue", tags=["Queue"])
