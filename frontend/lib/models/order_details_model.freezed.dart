...
@useResult
$Res call({
@JsonKey(name: "customer_name") String? customerName,@JsonKey(name: "order_number") String? orderNumber,@JsonKey(name: "order_status") String? orderStatus,@JsonKey(name: "order_time") DateTime? orderTime,@JsonKey(name: "total_cost") double? totalCost,@JsonKey(name: "items") List<QueueOrderLineResponseModel>? items
});
...
@JsonKey(name: "product_name") String? get productName;@JsonKey(name: "quantity_ordered") int? get quantityOrdered;
...
@useResult
$Res call({
@JsonKey(name: "product_name") String? productName,@JsonKey(name: "quantity_ordered") int? quantityOrdered
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "product_name")  String? productName, @JsonKey(name: "quantity_ordered")  int? quantityOrdered)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QueueOrderLineResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "product_name")  String? productName, @JsonKey(name: "quantity_ordered")  int? quantityOrdered)  $default,) {final _that = this;
switch (_that) {
case _QueueOrderLineResponseModel():
return $default(_that.productName,_that.quantityOrdered);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "product_name")  String? productName, @JsonKey(name: "quantity_ordered")  int? quantityOrdered)?  $default,) {final _that = this;
switch (_that) {
case _QueueOrderLineResponseModel() when $default != null:
return $default(_that.productName,_that.quantityOrdered);case _:
  return null;
...
class _QueueOrderLineResponseModel implements QueueOrderLineResponseModel {
  const _QueueOrderLineResponseModel({@JsonKey(name: "product_name") this.productName, @JsonKey(name: "quantity_ordered") this.quantityOrdered});
